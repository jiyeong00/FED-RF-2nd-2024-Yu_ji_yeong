...
/* 
    ...
    >> 그런데 이런 불필요한 태그 구조를 원치않는 경우 <React.Fragment>를 사용하면 내보낼때 하나로 묶는 역할만 하고 실제로 태그는 출력안됨
...
function MyFirstReact() {
  ...
  return (
    // 하나의 패키지만 가능
    // 방법1. 껍데기 만들어주기. 쓸데없는 구조가 생김
    // <div>
    //     <h1>나는 리액트가 좋아질 것 같다</h1>
    //     <h2>[ 리액트란 무엇인가? ]</h2>
    // </div>
    // 방법2,. 빈껍데기 만듬,>에러남 / CLI환경에서는 가능
    // <>
    //     <h1>나는 리액트가 좋아질 것 같다</h1>
    //     <h2>[ 리액트란 무엇인가? ]</h2>
    // </>
    ...
    <React.Fragment>
      <h1>나는 리액트가 좋아질 것 같다</h1>
      <img src="https://cdn.icon-icons.com/icons2/2415/PNG/512/react_original_wordmark_logo_icon_146375.png" alt="리액트 로고" width="200px"/>
      ...
      <h2>리액트 배우기</h2>
      <iframe width="100%" height="720px" src="https://www.youtube.com/embed/zuyH4QUuTZk" title="How to run React JS app in Visual studio code tutorial | Download and install react in VS Code 2024" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
