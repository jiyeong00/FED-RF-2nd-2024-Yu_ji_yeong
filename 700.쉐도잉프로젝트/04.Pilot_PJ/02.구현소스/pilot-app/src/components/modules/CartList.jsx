                              ...
                              <span>
                                ...
                                <button
                                  ...
                                  onClick={(e) => {
                                    ...
                                    // 5. 반영버튼 숨기기
                                    $(e.currentTarget).hide().next().hide();

                                    // -> 아래 5,6은 리랜더링 되면 해결됨
                                    // 그리고 데이터 변경 싱크가 맞지않는 경우가 생기게 됨
                                    // 데이터를 변경했음에도 리랜더링이 안된 이유는 배열의 객체값이 변경되거나 배열 순서를 변경한 경우 배열이 변경되었다고 체크되지 않는다,.
                                    // >>>>> 따라서 강제 리랜더링이 필요하다
                                    setForce(!force);
                                ...
                                <b
                                  ...
                                  onClick={(e) => {
                                    ...
                                    // 입력창의 blur이벤트 발생을 위해 강제로 포커스를 준다.
                                    tg.focus();

                                    // 하위클릭된 이미지 종류 파악하기
                                    // e.currentTarget = 버블링과 상관없이 이벤트가 걸린 요소 자신이 대상
                                    // e,target - 이벤트가 시작되는 원본 (버블링O)
