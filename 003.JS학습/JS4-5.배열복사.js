...
// 일반적인 값은 값 복사가 맞다!
// 그러나 배열/객체일 경우 컬렉션 집합을 만들고 주소로 관리가 되기 때문에 변수에 변수를 할당할때
// 값이 아닌 주소가 복사된다
...
// 배열변수 aa를 bb에 할당
let bb=aa;
console.log('bb변경 전 상태 \naa : ',aa,'\nbb',bb);

// bb의 특정 배열값을 변경
bb[0]=777;
console.log('bb변경 후 상태 \naa : ',aa,'\nbb',bb);
///////////////////////////////////////////////////
...
// parse()메서드는 구분을 분석하여 원래구문 형식으로 변환해주는 역할을 하는 메서드임
// stringify()메서드는 어떤 값이든 문자화하여 변환한다.
